...
import numpy as np
import pytest
from EvoloPy.optimizers.MFO import MFO
...
def test_MFO(sample_objective_function, sample_bounds):
    """Tests if the MFO algorithm runs correctly and produces a valid output."""
    lb, ub = sample_bounds
    dims = 5  # Number of dimensions
    PopSize = 10  # Population size
    iters = 30  # Number of iterations

    sol = MFO(sample_objective_function, lb, ub, dims, PopSize, iters)
